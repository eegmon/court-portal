    ...
    <div className="max-w-md mx-auto py-6 sm:py-8 px-2">
      <div className="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200/90 dark:border-slate-800 shadow-lg p-6 sm:p-8">
        <div className="text-center mb-5 sm:mb-6">
          ...
          <h1 className="text-xl sm:text-2xl font-bold text-slate-900 dark:text-white">법원 공무원 계정 생성</h1>
        ...
        {success && (
          <div className="bg-emerald-50 dark:bg-emerald-950/60 border border-emerald-200 dark:border-emerald-800 text-emerald-700 dark:text-emerald-300 rounded-xl p-3 text-xs mb-4 flex items-center gap-2">
            <span>✅</span>
            <span>{success}</span>
          </div>
        )}
